...
module SwaggerClient
  class AddArrivalResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ArrivalAdded')
        self.arrival_added = attributes[:'ArrivalAdded']
      end

      if attributes.has_key?(:'ClientService')
        self.client_service = attributes[:'ClientService']
      end
    end
    ...
    def hash
      [arrival_added, client_service].hash
    end
