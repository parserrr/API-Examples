...
module SwaggerClient
  ...
  class Availability
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'BookableEndDateTime')
        self.bookable_end_date_time = attributes[:'BookableEndDateTime']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          bookable_end_date_time == o.bookable_end_date_time &&
          location == o.location
    end
    ...
    def hash
      [id, staff, session_type, programs, start_date_time, end_date_time, bookable_end_date_time, location].hash
    end
