...
module SwaggerClient
  ...
  class BookingWindow
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'DailyStartTime')
        self.daily_start_time = attributes[:'DailyStartTime']
      end

      if attributes.has_key?(:'DailyEndTime')
        self.daily_end_time = attributes[:'DailyEndTime']
      end
    end
    ...
    def hash
      [start_date_time, end_date_time, daily_start_time, daily_end_time].hash
    end
