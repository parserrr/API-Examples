...
module SwaggerClient
  ...
  class ClientPurchaseRecord
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'AccountPayment')
        self.account_payment = attributes[:'AccountPayment']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          account_payment == o.account_payment &&
          price == o.price &&
    ...
    def hash
      [sale, description, account_payment, price, amount_paid, discount, tax, returned, quantity].hash
    end
