...
module SwaggerClient
  ...
  class ClientRelationship
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'RelatedClientId')
        self.related_client_id = attributes[:'RelatedClientId']
      end
      ...
      if attributes.has_key?(:'RelationshipName')
        self.relationship_name = attributes[:'RelationshipName']
      end
    end
    ...
    def hash
      [related_client_id, relationship, relationship_name].hash
    end
