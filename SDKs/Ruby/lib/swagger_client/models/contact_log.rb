...
module SwaggerClient
  ...
  class ContactLog
    ...
    def self.swagger_types
      {
        ...
        :'created_by' => :'Staff',
        :'assigned_to' => :'Staff',
        :'comments' => :'Array<ContactLogComment>',
        :'types' => :'Array<ContactLogType>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'AssignedTo')
        self.assigned_to = attributes[:'AssignedTo']
      end
    ...
    def hash
      [id, text, created_date_time, followup_by_date, contact_method, contact_name, client, created_by, assigned_to, comments, types].hash
    end
