...
module SwaggerClient
  ...
  class FormulaNote
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'EntryDateTime')
        self.entry_date_time = attributes[:'EntryDateTime']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          note == o.note &&
          entry_date_time == o.entry_date_time &&
    ...
    def hash
      [id, client_id, note, entry_date_time, appointment_id].hash
    end
