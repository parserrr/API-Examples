...
module SwaggerClient
  class GetClassSchedulesRequest
    ...
    # The end date of the range. Return any active enrollments that occur on or before this day.  <br />Default: **StartDate**
    ...
    # The start date of the range. Return any active enrollments that occur on or after this day.  <br />Default: **today’s date**
    ...
    def hash
      [class_schedule_ids, end_date, location_ids, program_ids, session_type_ids, staff_ids, start_date, limit, offset].hash
    end
