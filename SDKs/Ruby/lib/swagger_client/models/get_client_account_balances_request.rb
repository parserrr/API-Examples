...
module SwaggerClient
  class GetClientAccountBalancesRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'BalanceDate')
        self.balance_date = attributes[:'BalanceDate']
      end
    ...
    def list_invalid_properties
      ...
      if @client_ids.nil?
        invalid_properties.push('invalid value for "client_ids", client_ids cannot be nil.')
      end
    ...
    def valid?
      return false if @client_ids.nil?
      true
    end
    ...
    def hash
      [balance_date, class_id, client_ids, limit, offset].hash
    end
