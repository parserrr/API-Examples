...
module SwaggerClient
  class GetClientsRequest
    ...
    def hash
      [client_i_ds, search_text, is_prospect, last_modified_date, limit, offset].hash
    end
