...
module SwaggerClient
  class GetProductsRequest
    ...
    attr_accessor :sub_category_ids
    ...
    def self.swagger_types
      {
        ...
        :'sub_category_ids' => :'Array<Integer>',
        :'sell_online' => :'BOOLEAN',
        :'location_id' => :'Integer',
        :'limit' => :'Integer',
        :'offset' => :'Integer'
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'SubCategoryIds')
        if (value = attributes[:'SubCategoryIds']).is_a?(Array)
          self.sub_category_ids = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          sub_category_ids == o.sub_category_ids &&
    ...
    def hash
      [product_ids, search_text, category_ids, sub_category_ids, sell_online, location_id, limit, offset].hash
    end
