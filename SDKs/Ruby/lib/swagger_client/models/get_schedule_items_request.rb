...
module SwaggerClient
  class GetScheduleItemsRequest
    ...
    attr_accessor :ignore_prep_finish_times
    ...
    def self.swagger_types
      {
        ...
        :'start_date' => :'DateTime',
        :'end_date' => :'DateTime',
        :'ignore_prep_finish_times' => :'BOOLEAN',
        :'limit' => :'Integer',
        :'offset' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IgnorePrepFinishTimes')
        self.ignore_prep_finish_times = attributes[:'IgnorePrepFinishTimes']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          end_date == o.end_date &&
          ignore_prep_finish_times == o.ignore_prep_finish_times &&
          limit == o.limit &&
          offset == o.offset
    end
    ...
    def hash
      [location_ids, staff_ids, start_date, end_date, ignore_prep_finish_times, limit, offset].hash
    end
