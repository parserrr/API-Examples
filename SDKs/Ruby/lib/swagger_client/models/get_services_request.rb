...
module SwaggerClient
  class GetServicesRequest
    ...
    attr_accessor :hide_related_programs
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'SellOnline')
        self.sell_online = attributes[:'SellOnline']
      end
      ...
      if attributes.has_key?(:'HideRelatedPrograms')
        self.hide_related_programs = attributes[:'HideRelatedPrograms']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          sell_online == o.sell_online &&
          location_id == o.location_id &&
          hide_related_programs == o.hide_related_programs &&
          staff_id == o.staff_id &&
          limit == o.limit &&
          offset == o.offset
    end
    ...
    def hash
      [program_ids, session_type_ids, service_ids, class_id, class_schedule_id, sell_online, location_id, hide_related_programs, staff_id, limit, offset].hash
    end
