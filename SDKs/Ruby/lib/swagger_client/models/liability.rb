...
module SwaggerClient
  class Liability
    # The date and time at which the client agreed to the liability waiver for the business.
    attr_accessor :agreement_date

    # The client’s liability release status.<br />  When `true`, indicates that the client has agreed to the liability release for the business.<br />  When `false`, indicates that the client has not agreed to the liability release for the business.
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IsReleased')
        self.is_released = attributes[:'IsReleased']
      end

      if attributes.has_key?(:'ReleasedBy')
        self.released_by = attributes[:'ReleasedBy']
      end
    end
    ...
    def hash
      [agreement_date, is_released, released_by].hash
    end
