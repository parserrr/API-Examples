...
module SwaggerClient
  class Package
    ...
    # When `true`, only products that can be sold online are returned.<br />  When `false`, all products are returned.
    ...
    def hash
      [id, name, discount_percentage, sell_online, services, products].hash
    end
