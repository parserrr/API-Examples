...
module SwaggerClient
  class TimeCardEvent
    ...
    # The number of hours on this time card.
    attr_accessor :hours
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'TimeIn')
        self.time_in = attributes[:'TimeIn']
      end

      if attributes.has_key?(:'TimeOut')
        self.time_out = attributes[:'TimeOut']
      end
