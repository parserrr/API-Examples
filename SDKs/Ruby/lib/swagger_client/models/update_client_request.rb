...
module SwaggerClient
  class UpdateClientRequest
    ...
    # When `true`, the updated information is propagated to all of the region’s sites where the client has a profile.<br />  When `false`, only the local client is updated.<br />  Default: **true**
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'CrossRegionalUpdate')
        self.cross_regional_update = attributes[:'CrossRegionalUpdate']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          client == o.client &&
          test == o.test &&
          cross_regional_update == o.cross_regional_update &&
          new_id == o.new_id
    end
    ...
    def hash
      [client, test, cross_regional_update, new_id].hash
    end
