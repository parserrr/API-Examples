...
module SwaggerClient
  class UpdateClientServiceRequest
    ...
    # When `true`, indicates that input information is to be validated, but not committed.<br />  When `false` or omitted, the database is affected.<br />  Default: **false**
    attr_accessor :test
    ...
    def hash
      [service_id, active_date, expiration_date, test].hash
    end
