...
{	
	 ...
	 */
	public function GetServices(array $hideRelatedProgram, array $locationID, array $programIDs = array(), array $sessionTypeIDs = array(), array $serviceIDs = array(), int $classID = null, int $classScheduleID = null, bool $sellOnline = null, int $locationID = null, SourceCredentials $credentials = null, $XMLDetail = XMLDetail::Full, $PageSize = NULL, $CurrentPage = NULL, $Fields = NULL)
	{
		$additions = array();
		if (isset($programIDs))
		{
		...
		if (isset($hideRelatedProgram))
		{
			$additions['HideRelatedPrograms'] = $hideRelatedProgram;
		}
